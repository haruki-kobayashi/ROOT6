...
{
	// Convert: output_format_micro --> micro_track_subset_t
	// rawid, ax, ay, and z will be set to 0
	...
	// Convert: output_format_base --> base_track_t
	// zone, isg, m.rawid, m.ax, m.ay, and m.z will be set to 0
	...
	// Convert: output_format_link --> linklet_t
	// zproj, xc, b.zone, b.isg, b.m.rawid, b.m.ax, b.m.ay, and b.m.z will be set to 0
	...
	// Convert: micro_track_subset_t --> output_format_micro
	// px will be set to 0
	...
	// Convert: base_track_t --> output_format_base
	// m.px will be set to 0
	...
	// Convert: linklet_t --> output_format_link
	// b.m.px will be set to 0
	...
	// Check if the NETSCAN format linklet_t is plausible
	...
	// Check if the NINJA format output_format_link is plausible
